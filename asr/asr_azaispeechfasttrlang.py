...
class AsrAzAiSpeechFastTrLang(AsrBase):
        ...
        try:
            with open(transcript_obj.audio_wav_path, "rb") as audio_file:
                files = {
                    ...
                    "definition": (
                        None,
                        '{ "locales": ["es-ES"], "profanityFilterMode": "Masked", "channels": [0, 1] }',
                    ),
                }
            ...
            {"duration":9209,"combinedPhrases":[
                ...
                ],"phrases":[{"channel":0,"offset":80,"duration":7480,"text":"A todas estas las campanas seguían tocando con igual furia, prueba evidente de que el entusiasmo de los cuatro muchachos no había disminuido.","words":[{"text":"A","offset":80,"duration":240},{"text":"todas","offset":320,"duration":320},{"text":"estas","offset":640,"duration":480},{"text":"las","offset":1120,"duration":200},{"text":"campanas","offset":1320,"duration":520},{"text":"seguían","offset":1840,"duration":440},{"text":"tocando","offset":2280,"duration":400},{"text":"con","offset":2680,"duration":160},{"text":"igual","offset":2840,"duration":280},{"text":"furia,","offset":3120,"duration":720},{"text":"prueba","offset":3840,"duration":400},{"text":"evidente","offset":4240,"duration":440},{"text":"de","offset":4680,"duration":80},{"text":"que","offset":4760,"duration":80},{"text":"el","offset":4840,"duration":160},{"text":"entusiasmo","offset":5000,"duration":520},{"text":"de","offset":5520,"duration":80},{"text":"los","offset":5600,"duration":160},{"text":"cuatro","offset":5760,"duration":240},{"text":"muchachos","offset":6000,"duration":560},{"text":"no","offset":6560,"duration":80},{"text":"había","offset":6640,"duration":200},{"text":"disminuido.","offset":6840,"duration":720}],"locale":"es-ES","confidence":0.9384509}]}
            
            """
            azure_transcription = transcription_result.get("combinedPhrases", [{}])[
                0
            ].get("text", "")

            # azure_transcription = transcription_result.get("recognizedPhrases", [{}])[
            #     0
            # ].get("display", "")
            ...
            print("Azure Fast Transcription: ", azure_transcription)

            return TranscriptionResult(
                service="azure_fast_lang",
                transcription=azure_transcription,
                confidence=None,  # Azure Fast Transcription does not provide a confidence score
